...
if(isset($_POST['submit']))
{
  ...
  $info = $_POST['info'];
	...
	$sql = "INSERT INTO aregister(name,email,phone,address,account,password,confirmpsw,time,info) values('$name','$email','$phone','$address','$account','$password','$confirmpsw','$time','$info')";
