...
if(isset($_POST['account'])&& $_POST['password'])
{
    ...
    $sql=mysqli_query($con,"SELECT * FROM vregister where account='$account' and password='$password'");
    ...
    if(is_array($row))
    {
        ...
        echo "<br><a href='vaccineupdate.php' target='_blank' style='margin-left:850px;margin-bottom:30px;font-size:20px;'>Click to update Data</a>";  
