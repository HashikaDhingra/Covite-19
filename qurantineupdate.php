...
$query=mysqli_query($db,"SELECT * FROM qregister where account='$account'")or die(mysqli_error());
  ...
  <div class="container">
   ...
   <td><label for="email"><b>Address</b></label></td>
    ...
    <td>
     ...
     <input type="text" placeholder="Timings" name="available" id="time" style="width:100%" value="
            <?php 
            echo $row['available']; 
            ?>"  >
            </td></tr>
