...
.vertical {
  animation: 1s ease-out 0s 1 example1;
  animation-duration: 4s;
  animation-delay: -2s;
...
<body>
  <header>
    <div Class="topnav">
      ...
      <div class="login-container">
        <form action="foodlogin.php" method="POST">
    ...
    <form action="foodregister.php" method="POST">
    ...
    <div class="container">
      ...
      <input type="password" placeholder="Repeat Password" name="confirmpsw" id="psw-repeat" required>
       ...
       <input type="text" placeholder="Timings" name="time" id="aname">
  ...
  <hr>
      ...
      <div style="margin-top: -1270px;">
        <?php 
          $con=mysqli_connect("localhost","root","","covite-19") or die(mysqli_error());
          $sql=mysqli_query($con,"SELECT `name`, `email`, `phone`, `address`,`account`, `time`, `info` FROM fregister");
