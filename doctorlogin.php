...
{ 
    ...
    $sql=mysqli_query($con,"SELECT * FROM dregister where account='$account' and password='$password'");
    ...
    if(is_array($row))
    {
        ...
        echo "<br><a href='doctorupdate.php' target='_blank' style='margin-left:850px;margin-bottom:30px;font-size:20px;'>Click to update Data</a>";  
