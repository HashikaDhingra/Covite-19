  ...
  <header>
    <div Class="topnav">
      ...
      <div class="login-container">
        <form action="vaccinelogin.php" method="POST">
    ...
    <form action="vaccineregister.php" method="POST">
     <div class="vertical"></div>
    <div class="container">
      <h1>Register as a Vaccine Provider.</h1>
...
<br><br>
  ...
  <?php 
          ...
          $sql=mysqli_query($con,"SELECT `name`, `email`, `phone`, `address`,`account`, `time`, `info` FROM vregister");
